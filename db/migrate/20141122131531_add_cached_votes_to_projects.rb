class AddCachedVotesToProjects < ActiveRecord::Migration
def self.up
  ...
  def self.down
    remove_column :projects, :cached_votes_total
    remove_column :projects, :cached_votes_score
    remove_column :projects, :cached_votes_up
    remove_column :projects, :cached_votes_down
    remove_column :projects, :cached_weighted_score
    remove_column :projects, :cached_weighted_total
    remove_column :projects, :cached_weighted_average
  end
end
